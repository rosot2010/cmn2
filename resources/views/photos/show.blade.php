...
<li><img style="max-height:500px;width:500px;" src="../images/{{$photo->image_path}}"alt="image"></a></li> 
<li>
...
<button class="btn-success btn" onclick="incrementValue()"value="Vote">vote</button>
</ul>  <h3>Comment</h3>
