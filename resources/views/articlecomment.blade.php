...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section class="col-sm-4">
      <article>
<h3><BUTTON>|COMMMENTS|</BUTTON></h3>

 @foreach($articlecomments as $articlecomments)
 <li style="font-weight:bold;color:green;list-style-type:none">{{$articlecomments->id}}</li>
<li style="font-weight:bold;color:green;list-style-type:none">{{$articlecomments->name}}</li> <br />
<li style="list-style-type:none">{{$articlecomments->body}}</li> 
 @endforeach
</ul><br/>
</article></section>
<div class="container-fluid">
