...
<ul class="nav" id="side-menu">
  ...
  <article>
<ul style="list-style-type:none"><h3>|VOTE RESULTS|</h3>
@foreach($posts as $post)
<li style="list-style-type:none">{{$post->artist_name}}</li>
<li style="list-style-type:none">{{$post->record_label}}</li>
<li style="list-style-type:none;font-weight:bold;color:black">{{$post->vote}}</li>{{'=================='}}
