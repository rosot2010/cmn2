...
<a href=""><li style="color:black;font-weight:bold;font-family:palatino-linotype;">{{$comment->name}}</li>
<li style="color:black;font-weight:bold;font-family:palatino-linotype;">{{$comment->body}}</li>  
