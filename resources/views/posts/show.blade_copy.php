...
<a href=""><li style="color:black;font-weight:bold;font-family:palatino-linotype;">{{$post->artist_name}}</li>
<li style="color:black;font-weight:bold;font-family:palatino-linotype;">{{$post->record_label}}</li>  
<li><img style="max-height:500px;width:500px;" src="../images/{{$post->image_path}}"alt="image"></a></li> 
<li>
<video controls autoplay>

 <source scale="aspect" src="../images/{{$post->image_path2}}" type='video/mp4'  >
 <source scale="aspect" src="../images/{{$post->image_path2}}" type='video/mp3'  >
  <source scale="aspect" src="../images/{{$post->image_path2}}" type='video/m4v'  >
 <source scale="aspect" src="../images/{{$post->image_path2}}" type='video/webm'  >
 <source scale="aspect" src="../images/{{$post->image_path2}}" type='video/ogg' >
  </video></li>
  {!!Form::model($post,['method'=>'PATCH','action'=>['PostsController@update',$post->id]])!!}
  {{csrf_field()}} 
  {!!Form::hidden('artist_name',null,['class'=>'form-control'])!!}
  {{csrf_field()}} 
  {!!Form::hidden('record_label',null,['class'=>'form-control'])!!}
  
                   {{csrf_field()}} 
                   {!!Form::submit('vote',['class'=>'btn btn-info'])!!}
                   {!!Form::close()!!}
</ul>  <h3>Comment</h3>
    <section class="col-sm-4">
{!!Form::open(['method'=>'POST','action'=>'ArticlesCommentsController@store'])!!}
<div class="form-group">
