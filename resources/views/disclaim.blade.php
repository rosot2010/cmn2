...
<ul class="nav" id="side-menu">
     ...
     <article style="line-height:30.7px;padding:20px;">
      ...
      <h3>Disclaimer</h3>
      This</span> is a social interaction platform provided and maintained by<p> <a href="index.php"style="color:maroon;font-weight:bold;font-size:18px;">Naijatop100hitz</a></p>
      and does not constitute any form of acknowledgement.Whilst we require users to act with best practice and interact responsibly,
      we  have not verified any claims 
      or statements or pre verify or edit  any messages, or uploads,
       locations or opportunities promoted. 
       naijatop100hitz</a></p> does not own or control and is not responsible for the videos, pictures, 
      ...
      You must perform your own research and seek independent professional advice before making any decision on whatever is uploaded on this site
      </p>
</p></article></div></div>
